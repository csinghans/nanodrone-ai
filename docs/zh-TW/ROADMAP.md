...
- **L29** 取下一個空號，作為 Track B 的*預測前沿*：新能力一律取下一個編號、不插進已穩定的 L11–L28 圖，故 L29 雖編號排在 Track C 的 L27–L28 之後，仍歸 Track B。產生的 DroneVoice docs 頁改號為 `31-dronevoice.md`，讓帶編號的課（L29 世界模型與 L30 課程總結）排在它之前。
