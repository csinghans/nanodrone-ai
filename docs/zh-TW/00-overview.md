...
（找安裝步驟？在[從這裡開始](START-HERE.md)——兩支 setup 腳本，然後就是你的第一次飛行。）
...
1. **免費** — 必修軌全程都在模擬器裡；真機是接近尾聲、標好價的可選一步（Track E）。
...
| 任務 | 11–13、14a、16 | 把技能組成有安全機制的完整任務，收在有評分表的 capstone（沒有第 15 課——第 14 課拆成 14a/14b） |
| 上晶片 | 14b、17–22 | 深度、光流、RL 避障——每一項都蒸餾到塞得進無人機晶片 |
| 前沿 | 23–30 | 飛行黑盒子、真機踏腳石、共用指令協議、nano 世界模型（research preview——深入研究見 [microdrone-world-model](https://github.com/csinghans/microdrone-world-model)）、課程總結 |
